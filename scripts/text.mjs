...
export const TEXT = {
  ja: {
    ...
    labels: {
      ...
      byYear: "年ごとのコミット", byOrg: "置き場所ごとのコミット", breakdown: "言語と置き場所",
  ...
  en: {
    ...
    labels: {
      ...
      byYear: "Commits by year", byOrg: "Commits by org", breakdown: "Languages and orgs",
  ...
  zh: {
    ...
    labels: {
      ...
      byYear: "各年提交", byOrg: "各存放处的提交", breakdown: "语言与存放处",
