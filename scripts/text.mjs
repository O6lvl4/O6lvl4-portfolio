...
export const TEXT = {
  ja: {
    ...
    labels: {
      ...
      about: "これまで", work: "仕事", orgs: "置き場所", stack: "書いている言語", history: "年表",
      byYear: "年ごとのコミット", byOrg: "置き場所ごとのコミット",
  ...
  en: {
    ...
    labels: {
      ...
      about: "About", work: "Work", orgs: "Where it lives", stack: "What it is written in", history: "Timeline",
      byYear: "Commits by year", byOrg: "Commits by org",
  ...
  zh: {
    ...
    labels: {
      ...
      about: "关于", work: "作品", orgs: "存放处", stack: "用什么写的", history: "年表",
      byYear: "各年提交", byOrg: "各存放处的提交",
